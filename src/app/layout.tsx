...
export const metadata: Metadata = {
	...
	icons: {
		...
		apple:
			"https://res.cloudinary.com/dizm8txou/image/upload/v1715953409/about-us/static/favicons/apple-touch-icon.png",
	},
		...
		<html lang="en" className="min-h-dvh">
			<head>
				...
				<link
					...
					href="https://res.cloudinary.com/dizm8txou/image/upload/v1715953409/about-us/static/favicons/apple-touch-icon.png"
				/>
			</head>
